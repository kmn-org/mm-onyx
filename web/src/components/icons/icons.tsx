...
export const OnyxIcon = ({
  ...
  return (
    <svg
      style={{ width: `${size}px`, height: `${size}px`, fill: "var(--logo-pictogram)" }}
      className={`w-[${size}px] h-[${size}px] ` + className}
      xmlns="http://www.w3.org/2000/svg"
      width="200"
      height="200"
      viewBox="0 0 512 512"
    >
      <path d="M152.839 129.001L39.7098 324.918L6.33447 383H233.894V324.918H114.696L227.826 129.001H152.839Z"/>
      <path d="M284.608 129L397.737 324.918H278.973V383H505.665L472.29 324.918L359.161 129H284.608Z"/>
      <path d="M256 194.885L212.655 270.305H299.345L256 194.885Z"/>
    </svg>
  );
};
export const OnyxLogoTypeIcon = ({
  ...
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
      viewBox="0 0 704.7 184.2"
      className={className}
      style={{ fill: "var(--logo-text)" }}
    >
      {/* MATICMIND text */}
      <path
        d="M582.9,98.7v-9.2h9.9c2.2,0,4.2-.3,6.1-.9,1.9-.6,3.6-1.5,5.1-2.8s2.6-2.9,3.4-4.8c.8-1.9,1.2-4.3,1.2-7s-.4-5.1-1.2-7-2-3.6-3.4-4.8c-1.5-1.3-3.1-2.2-5.1-2.8-1.9-.6-4-.9-6.1-.9h-9.9v-9.2h10.3c5.2,0,9.7,1,13.6,3,3.9,2,6.9,4.9,9.1,8.6,2.2,3.7,3.2,8,3.2,13.1s-1.1,9.4-3.2,13.1c-2.2,3.7-5.2,6.5-9.1,8.6-3.9,2-8.4,3-13.6,3,0,0-10.3,0-10.3,0ZM586.7,98.7h-10.3v-49.3h10.3v49.3ZM567.5,49.3v51.8l-35.1-33v30.6h-9.7v-51.8l35.1,33v-30.6s9.7,0,9.7,0ZM513.8,98.7h-10.2v-49.3h10.2v49.3ZM407.4,82.5c1.5,2.4,3.4,4.3,5.8,5.6,2.4,1.3,5,1.9,7.8,1.9s4.4-.3,6.3-.9c1.8-.6,3.5-1.4,5-2.5,1.5-1,2.8-2.2,3.8-3.4v11.3c-2,1.6-4.2,2.8-6.6,3.7-2.4.9-5.4,1.3-9,1.3s-7.2-.6-10.5-1.8c-3.2-1.2-6-3-8.4-5.3s-4.2-5-5.5-8.1-1.9-6.6-1.9-10.4.6-7.3,1.9-10.4,3.1-5.8,5.5-8.1,5.2-4.1,8.4-5.3c3.2-1.2,6.7-1.8,10.5-1.8s6.6.4,9,1.3c2.4.9,4.6,2.1,6.6,3.7v11.3c-1.1-1.2-2.4-2.3-3.8-3.4-1.5-1-3.1-1.9-5-2.5-1.8-.6-3.9-.9-6.3-.9s-5.4.6-7.8,1.9c-2.4,1.3-4.3,3.1-5.8,5.5s-2.2,5.2-2.2,8.5.7,6.1,2.2,8.5M388.2,98.7h-10.2v-49.3h10.2v49.3ZM337.4,49.3h36.6v9.1h-13.3v40.2h-10.1v-40.2h-13.2v-9.1Z"
      />
      {/* ZENITA GROUP text */}
      <path
        d="M430.2,120.6h4.1c1.3,0,2.5.2,3.5.7s1.9,1.2,2.5,2.1.9,2,.9,3.2-.3,2.3-.9,3.2-1.4,1.6-2.5,2.1c-1,.5-2.2.7-3.5.7h-4.1v-2.3h4.1c1.3,0,2.4-.3,3.2-1,.8-.6,1.2-1.6,1.2-2.8s-.4-2.2-1.2-2.8c-.8-.6-1.9-.9-3.2-.9h-4.1v-2.3h0ZM431.3,140.9h-2.5v-20.3h2.5v20.3ZM413,120.6v13.6c0,1.4.4,2.5,1.1,3.4.8.9,1.9,1.3,3.3,1.3s2.6-.4,3.3-1.3c.8-.9,1.1-2,1.1-3.4v-13.6h2.5v13.6c0,1-.2,1.9-.5,2.8-.3.9-.8,1.6-1.4,2.2s-1.3,1.1-2.2,1.5c-.9.3-1.8.5-2.8.5s-2-.2-2.8-.5c-.9-.3-1.6-.8-2.2-1.5s-1.1-1.4-1.4-2.2-.5-1.8-.5-2.8v-13.6h2.5ZM387.4,126.7c.5-1.3,1.2-2.4,2.2-3.3.9-.9,2-1.7,3.3-2.2s2.6-.8,4.1-.8,2.9.3,4.1.8,2.3,1.3,3.3,2.2c.9.9,1.6,2,2.2,3.3.5,1.3.8,2.6.8,4.1s-.3,2.8-.8,4.1-1.2,2.4-2.2,3.3c-.9.9-2,1.7-3.3,2.2-1.2.5-2.6.8-4.1.8s-2.8-.3-4.1-.8c-1.3-.5-2.3-1.3-3.3-2.2-.9-.9-1.6-2-2.2-3.3-.5-1.3-.8-2.6-.8-4.1s.3-2.9.8-4.1M390.3,134.9c.7,1.2,1.6,2.1,2.7,2.8,1.2.7,2.5,1,3.9,1s2.8-.3,4-1c1.1-.7,2.1-1.6,2.7-2.8.7-1.2,1-2.6,1-4.1s-.3-2.9-1-4.1-1.6-2.1-2.7-2.8c-1.2-.7-2.5-1-4-1s-2.8.3-3.9,1-2.1,1.6-2.7,2.8-1,2.6-1,4.1.3,2.9,1,4.1M372.9,120.6h4.1c1.3,0,2.5.2,3.5.7s1.9,1.2,2.5,2.1.9,2,.9,3.2-.3,2.3-.9,3.2-1.4,1.6-2.5,2.1c-1,.5-2.2.7-3.5.7h-4.1v-2.2h4.1c.9,0,1.6-.2,2.3-.5s1.2-.8,1.6-1.3c.4-.6.6-1.3.6-2.1s-.2-1.5-.6-2.1-.9-1-1.6-1.3-1.4-.5-2.3-.5h-4.1v-2.2.2ZM374,140.9h-2.5v-20.3h2.5v20.3ZM378,130.9l7.2,10h-3l-7-10h2.8ZM358.5,130.6h9.4c0,1.4-.2,2.8-.6,4-.4,1.3-1.1,2.4-1.9,3.4s-1.9,1.8-3.1,2.3c-1.2.6-2.6.9-4.1.9s-2.8-.3-4.1-.8c-1.3-.5-2.3-1.2-3.3-2.2s-1.6-2-2.2-3.3c-.5-1.3-.8-2.7-.8-4.2s.3-2.9.8-4.2c.5-1.3,1.2-2.4,2.2-3.3.9-.9,2-1.7,3.3-2.2s2.6-.8,4.1-.8,2.4.2,3.5.5,2,.8,2.8,1.5,1.6,1.4,2.1,2.4l-1.7,1.6c-.6-1.1-1.5-1.9-2.7-2.5-1.1-.6-2.5-.9-4-.9s-2.7.3-3.9,1c-1.2.7-2.1,1.6-2.8,2.8-.7,1.2-1,2.6-1,4.2s.3,2.9,1,4.1c.7,1.2,1.6,2.1,2.8,2.8,1.2.7,2.5,1,3.9,1s1.9-.1,2.7-.4c.8-.3,1.5-.7,2.1-1.3.6-.5,1.1-1.2,1.4-1.9.4-.7.7-1.4.8-2.2h-6.8v-2.3h.1ZM324.6,134.6l.2,1.1-2.5,5.2h-5.5l10.7-21.6,10.7,21.6h-5.6l-2.4-5,.2-1.2-2.9-6.6-2.8,6.6h-.1ZM322.4,133.3h10.1l.3,3.7h-10.7l.3-3.7h0ZM303.5,120.6h16.1v4.4h-5.6v15.9h-4.9v-15.9h-5.6s0-4.4,0-4.4ZM301.2,140.9h-5v-20.3h5v20.3ZM292,120.6v21.3l-14-12.4v11.4h-4.7v-21.3l14,12.4v-11.4h4.7ZM260.4,140.9h-4.7v-20.3h4.7v20.3ZM259,128.3h9.7v3.9h-9.7v-3.9ZM259,120.6h10.2v4h-10.2v-4ZM259,136.9h10.2v4h-10.2v-4ZM237.3,120.6h15.9l-9.6,16.1h8.6v4.2h-16.3l9.5-15.9h-8.1v-4.4h0Z"
      />
      {/* A triangle in MATICMIND */}
      <polygon
        points="321.2 46.8 295.6 98.6 306.3 98.6 321.2 67.7 336.2 98.6 346.8 98.6 321.2 46.8"
      />
      {/* M accent (first letter) - uses accent color */}
      <polygon
        style={{ fill: "var(--logo-accent)" }}
        points="264.8 78.6 244.1 46.8 236.8 98.6 247.3 98.6 250.5 70.9 264.8 94 279.1 70.9 282.3 98.6 292.8 98.6 285.4 46.8 264.8 78.6"
      />
      {/* M in MATICMIND (second M) */}
      <polygon
        points="469.5 78.7 448.8 46.9 441.5 98.7 452 98.7 455.2 71 469.5 94.1 483.8 71 486.9 98.7 497.4 98.7 490.1 46.9 469.5 78.7"
      />
      {/* Pictogram - left triangle - uses pictogram color (same as text in dark mode) */}
      <polygon
        style={{ fill: "var(--logo-pictogram)" }}
        points="138.7 46.9 115.5 87.1 108.7 99 155.3 99 155.3 87.1 130.9 87.1 154.1 46.9 138.7 46.9"
      />
      {/* Pictogram - right triangle */}
      <polygon
        style={{ fill: "var(--logo-pictogram)" }}
        points="165.8 46.9 189 87.1 164.6 87.1 164.6 99 211 99 204.2 87.1 181 46.9 165.8 46.9"
      />
      {/* Pictogram - center triangle */}
      <polygon
        style={{ fill: "var(--logo-pictogram)" }}
        points="159.9 60.4 151 75.9 168.8 75.9 159.9 60.4"
      />
    </svg>
  );
};
