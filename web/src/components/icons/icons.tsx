...
export const OnyxIcon = ({
  ...
  return (
    <svg
      ...
      fill="none"
    >
      <path d="M152.839 129.001L39.7098 324.918L6.33447 383H233.894V324.918H114.696L227.826 129.001H152.839Z" fill="#60B8CC"/>
      <path d="M284.608 129L397.737 324.918H278.973V383H505.665L472.29 324.918L359.161 129H284.608Z" fill="#60B8CC"/>
      <path d="M256 194.885L212.655 270.305H299.345L256 194.885Z" fill="#60B8CC"/>
    </svg>
  );
};
export const OnyxLogoTypeIcon = ({
  ...
  return (
    ...
    >
      ...
      />
      <polygon fill="#92fcec" points="159.9 60.4 151 75.9 168.8 75.9 159.9 60.4" />
    </svg>
  );
};
